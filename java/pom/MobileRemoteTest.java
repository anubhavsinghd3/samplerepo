...
public class MobileRemoteTest {
	...
	public static void main(String[] args) throws IOException {
		...
		RemoteWebDriver driver = new RemoteWebDriver(
				new URL("https://" + user + ':' + password + '@' + host + "/nexperience/wd/hub"), capabilities);
	...
	/*
	 * // Load page nxcView = nxcView.init();
	 * 
	 * // Put credentials and submit nxcView =
	 * nxcView.putUsername("John").putPassword("Perfecto1"); nxcView =
	 * nxcView.submit();
	 * 
	 * // Go to OCR Page. Casting necessary. nxcView = ((MainView)
	 * nxcView).clickOcrLink();
	 */

	/**
	 * Download all the report attachments with a certain type. type - video, image,
	 * vital, network Examples: downloadAttachment("video", "C:\\test\\video",
	 * "flv"); downloadAttachment("image", "C:\\test\\Image", "jpg");
	 */
	private void downloadAttachment(RemoteWebDriver driver, String type, String fileName, String suffix)
			throws IOException {
		try {
